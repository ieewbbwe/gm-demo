...
public class Account {
    ...
    public Account(String _id, String account_name, String account_type, String _sync_id, String dirty, String mutators, String calendar_display_name, String calendar_color, String calendar_color_index, String calendar_access_level, String visible, String sync_events, String calendar_location, String calendar_timezone, String ownerAccount, String isPrimary, String maxReminders, String allowedReminders, int deleted, String cal_sync1) {
        this._id = _id;
